...
// CHECK: %1 = trunc i32 %0 to i8
// CHECK: %conv = zext i8 %1 to i32
// CHECK: ret i32 %conv
...
// CHECK: %arrayidx = getelementptr inbounds [37 x i8], [37 x i8]* @ntz_reisers_alg.table, i64 0, i64 %idxprom
// CHECK: %0 = load i8, i8* %arrayidx, align 1, !tbaa !6
