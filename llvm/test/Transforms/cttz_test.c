// RUN: clang -target riscv64-linux-unknown-elf -no-canonical-prefixes --gcc-toolchain=/home/syrmia/gcc/INSTALL_DIR --sysroot=/home/syrmia/gcc/INSTALL_DIR/SYSROOT_DIR -O2 -S %s -emit-llvm -static -o - | opt -aggressive-instcombine -mtriple riscv64-linux-elf -S -o - | /home/syrmia/Desktop/llvm/llvm-project/build/bin/FileCheck %s
...
// CHECK: %arrayidx = getelementptr inbounds [37 x i8], ptr @ntz_reisers_alg.table, i64 0, i64 %idxprom
// CHECK: %0 = load i8, ptr %arrayidx, align 1, !tbaa !6
// CHECK: %conv = zext i8 %0 to i32
// CHECK: ret i32 %conv
int ntz_reisers_alg(unsigned x) {
